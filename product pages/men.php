...
$products = mysqli_query($con, "SELECT * FROM prod WHERE category_id = 'men'");
session_start();
?>
...
<main>
    <h2 class="page-title">منتجات الرجالي</h2>
    <div class="products-container">
        <?php while ($product = mysqli_fetch_assoc($products)) : ?>
            <div class="product">
                ...
                <div class="buttons">
                <a href="../Shopping/add_to_cart.php?product_id=<?php echo $product['id']; ?>" class='btn btn-primary btn-sm'>اضافة الى السلة</a>
